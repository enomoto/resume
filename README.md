...
スクラムマスターとしては、主に開発チームを中心とした日々のスクラムの運用と、ふりかえりを軸にした継続的な改善を行なっています。現在の組織では「デュアルトラックアジャイル」を採用しており、施策の仮説検証を行うディスカバリーチームと、実装をメインで行うデリバリーチームに分かれています。そのため両者を繋ぎ効果的な開発ができる体制を構築する取り組みをしています。
